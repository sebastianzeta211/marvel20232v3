...
export default {
  ...
  created(){   
  // let i = this.obtener()
  console.log("que es esto",this.$route.params.id);

    const api ='https://gateway.marvel.com:443/v1/public/characters/'+this.$route.params.id+'?ts=1&apikey=71fc19c18b1299bedd5c429e595365cc&hash=1a13f7c85ca4c7b330d3d16ba5ab87c5';
    fetch(api)
    .then(res=> {
      if(res.status==200){
